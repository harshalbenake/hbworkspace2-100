/*
 * Copyright (c) 2012 Google Inc. Licensed under the Apache License, Version 2.0 (the "License");
...
package com.fastre.inapp.utils;
...
public class IabHelper {
	 ...
	 * 
	 * @param ctx
	 *            Your application or Activity context. Needed to bind to the in-app billing
	 *            service.
	 * @param base64PublicKey
	 *            Your application's public key, encoded in base64. This is used for verification of
	 *            purchase signatures. You can find your app's base64-encoded public key in your
	 *            application's page on Google Play Developer Console. Note that this is NOT your
	 ...
	 * @param extraData
	 *            Extra data (developer payload), which will be returned with the purchase data when
	 *            the purchase completes. This extra data will be permanently bound to that purchase
...
/**
	 ...
	 *            if true, SKU details (price, description, etc) will be queried as well as purchase
	 *            information.
	 * @param moreItemSkus
	 *            additional PRODUCT skus to query information on, regardless of ownership. Ignored
