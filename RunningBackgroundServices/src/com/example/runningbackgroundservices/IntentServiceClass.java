...
public class IntentServiceClass extends Service{
	...
	public IntentServiceClass() {
		...
		System.out.println(" IntentServiceClass() ");
	}

	@Override
	public IBinder onBind(Intent intent) {
		System.out.println("IntentServiceClass onBind() ");
		return null;
	}
	...
	public void onCreate() {
		super.onCreate();
		System.out.println("IntentServiceClass onCreate() ");
		startService();
	}
	...
	private final Handler toastHandler = new Handler() {
		public void handleMessage(Message msg) {
			...
			myServices.getTopActivity(context);
